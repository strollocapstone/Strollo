...
const MAP_FILTERS = [
  { id: "ai-highlights", label: "AI Suggestions", defaultOn: true },
...
function FilterIcon({ id }) {
  ...
  switch (id) {
    case "ai-highlights":
      return <svg {...p}><path d="M9 18h6M10 21h4M12 3a6 6 0 0 0-4 10.5c.8.8 1.3 1.5 1.5 2.5h5c.2-1 .7-1.7 1.5-2.5A6 6 0 0 0 12 3z" /></svg>;
    case "saved-places":
    ...
    <div className={`pwc-screen${embedded ? " pwc-screen--embedded" : ""}${closing ? " pwc-screen--closing" : ""}`}>
      {!embedded && (
        <div className="pwc-header">
          <span className="pwc-title">Set your preferences</span>
        </div>
      )}
