...
// ── Walk Companion pill (always visible in minimized state) ───────────────
function WalkCompanionPill({ listening, locked, muted, aiSpeaking, userText, aiText, onMuteToggle, onListenStart, onListenEnd, onDragLock, onUnlock, onExpandVoice }) {
...
// ── NavigationScreen ───────────────────────────────────────────────────────
export default function NavigationScreen({ onGoBack, journeyItems = [] }) {
